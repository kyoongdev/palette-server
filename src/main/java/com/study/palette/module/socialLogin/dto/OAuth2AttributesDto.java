...
public class OAuth2AttributesDto {
  ...
  private final OAuth2UserInfo oAuth2UserInfo;  // 소셜 타입별 로그인 유저 정보(닉네임, 이메일 프로필 등)
  ...
  /**
   * SocialType에 맞는 메소드 호출하여 OAUthAttributes 객체 반환한다. param: userNameAttributesName -> OAUth2 로그인 시
   * 키(pk가 되는 값, attributes : OAuth 서비스의 유저 정보들
   */
