...
public class SocialLoginController {
    ...
    public ResponseEntity<?> getSocialLoginUrl(@PathVariable(name="socialLoginType") String socialLoginPath, HttpServletResponse response) throws IOException {
    ...
    public String naverResult(@RequestParam(name = "code") String code) throws JsonProcessingException {
