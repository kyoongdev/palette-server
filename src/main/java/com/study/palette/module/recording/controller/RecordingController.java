...
public class RecordingController {
    ...
    @GetMapping("")
    public PaginationDto<RecordingResponseDto> recordingInfos(@ParameterObject FindRecordingQuery query) {
        return recordingService.getRecordings(query, query.toPageable(Sort.by(Sort.Direction.DESC, "createdAt")));
    }
    ...
    public ResponseEntity<RecordingCreateResponseDto> createRecording(@Valid @RequestBody RecordingCreateRequestDto recordingCreateRequestDto, @Parameter(hidden = true) @GetUserInfo MyInfoResponseDto myInfoResponseDto) {
        return ResponseEntity.ok(recordingService.createRecording(recordingCreateRequestDto, myInfoResponseDto.getUser()));
    }
    ...
    @PreAuthorize("hasRole('MUSICIAN')")
    public void updateRecording(@PathVariable String id, @RequestBody RecordingUpdateReqeustDto recordingCreateRequestDto, @GetUserInfo MyInfoResponseDto myInfoResponseDto) {
        recordingService.updateRecording(id, recordingCreateRequestDto, myInfoResponseDto.getUser());
    }
