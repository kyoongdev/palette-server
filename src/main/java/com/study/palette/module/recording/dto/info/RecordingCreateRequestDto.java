...
public class RecordingCreateRequestDto {
    ...
    @Schema(description = "스튜디오 주소 (도/특별시/광역시)", defaultValue = "", type = "int", allowableValues = Address1.getNames())
    private String studioAddress1;
    @Schema(description = "스튜디오 주소 (시/군/구)", defaultValue="", type = "int", allowableValues = {"NEW", "POPULAR", "RECOMMEND", "SCORE"})
