...
public class FileUploadController {
    ...
    public ResponseEntity<FileUploadDto> imageUpload(@RequestBody @FileType("image") MultipartFile file) throws IOException {
    ...
    public ResponseEntity<FileUploadDto> fileUpload(@RequestBody @FileType(value = "image", isAllow = false) MultipartFile file) throws IOException {
        return ResponseEntity.ok(fileUploadService.saveFile(file));
    }
