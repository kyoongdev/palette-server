...
public class QChatRoomUser extends EntityPathBase<ChatRoomUser> {
    ...
    private static final long serialVersionUID = 1588941936L;
    ...
    public QChatRoomUser(Class<? extends ChatRoomUser> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.study.palette.module.user.entity.QUser(forProperty("user")) : null;
    }
